// Three.js - Billboard Labels w/Sprites height adjusted
// from https://threejsfundamentals.org/threejs/threejs-billboard-labels-w-sprites-adjust-height.html
...
function main() {
 ...
 // console.log(controls);
  ...
  const bodyHeight = 2;
  const bodyRadialSegments = 10;
  const bodyGeometry = new THREE.CylinderBufferGeometry(
      bodyRadiusTop, bodyRadiusBottom, bodyHeight, bodyRadialSegments);

  const headRadius = bodyRadiusTop * 0.8;
  const headLonSegments = 20;
  const headLatSegments = 20;
